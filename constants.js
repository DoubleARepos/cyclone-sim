...
UI.init = function () {
    ...
    let startItems = ["Watch it all unfold before your eyes.", "Your reliable tropical cyclone simulator.",
        "As accurate as it can possibly get.", "A window into the unknown.",
        "Reality is far worse than you think.", "Apologies if this eats up your RAM.", "The marvel of nature in the form of spinning icons on a screen."];
